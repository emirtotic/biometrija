		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>Vrste biometrijske zastite</h1>
						</div>
					</div>
				</div>
				<!-- /.container-fluid -->
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">Sve vrste :</h3>
									...
									<table class="table table-bordered">
										...
										<tbody id="sort-list">
											...
											<c:forEach var="vrsta" items="${vrstaList}">
												...
												<tr>
													<td><strong>${vrsta.name}</strong></td>
													<td><strong>${vrsta.description}</strong></td>
													<td><strong>${vrsta.text}</strong></td>
													<td><strong>${vrsta.image}</strong></td>

													<td class="text-center">
														<div class="btn-group">
														<a href="vrsta-form-update?id=${vrsta.id}"
																class="btn btn-info"> <i class="fas fa-edit"></i>
															</a>
															<button type="button" class="btn btn-info"
																data-toggle="modal"
																data-target="#delete-modal-${vrsta.id}">
												...
												<div class="modal fade" id="delete-modal-${vrsta.id}">
													<div class="modal-dialog">
														<div class="modal-content">
															<div class="modal-header">
																<h4 class="modal-title">Izbrisi vrstu</h4>
															...
															<div class="modal-body">
																<p>Da li stvarno zelite da izbrisete vrstu?</p>
																<strong></strong>
															</div>
															<div class="modal-footer justify-content-between">
																<button type="button" class="btn btn-default"
																	data-dismiss="modal">Cancel</button>
																<a href="vrsta-delete?id=${vrsta.id}"
