				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12">
									 ...
									 <form:form role="form" action="vrsta-save" modelAttribute="vrsta">
						                ...
						                <div class="card-body">
						                  ...
						                  <div class="form-group">
						                    <label>Tekst</label>
						                    <form:input path="text" class="form-control" placeholder="Enter full text"/>
